...
.container-star {
  background-image: linear-gradient(to bottom, rgba(8, 53, 75, 0.73), rgba(3, 3, 3, 0.692)),
  url("https://i.imgur.com/6OfGEce.png");
  background-size: cover;
}

.container-star:after {
  background: radial-gradient(ellipse at center, rgba(255, 255, 255, 0) 0%,
    rgba(255, 255, 255, 0) 40%, rgba(15, 10, 38, 0.2) 100%);
  content: "";
  width: 100%;
  height: 100%;
  position: absolute;
...
.star-1:before {
  background: radial-gradient(ellipse at center, rgba(255, 255, 255, 0.5) 0%,
...
.wing-left {
  background: linear-gradient(to bottom, #8db4c4 0%, #798da8 100%);
  transform: translate3d(0, 0, 0) rotateX(-30deg);
  animation: wingLeft 1.3s cubic-bezier(0.45, 0, 0.5, 0.95) infinite;
}

.wing-right {
  background: linear-gradient(to bottom, #d3dbe2 0%, #a5c1d1 100%);
  transform: translate3d(0, 0, 0) rotateX(-30deg);
...
@keyframes wingLeft {
  ...
  50% {
    ...
    background: linear-gradient(to bottom, #d9d3e2 0%, #a5afd1 100%);
  }
}
...
@keyframes wingLeftTop {
  ...
  50% {
    ...
    border-bottom: 20px solid #a5b1d1;
  }
}
...
@keyframes wingRight {
  ...
  50% {
    transform: translate3d(0, -20px, 0) rotateX(130deg);
    background: linear-gradient(to bottom, #8da5c4 0%, #7995a8 100%);
  }
}
...
@keyframes wingRightTop {
  ...
  50% {
    ...
    border-bottom: 20px solid #798ca8;
  }
}
